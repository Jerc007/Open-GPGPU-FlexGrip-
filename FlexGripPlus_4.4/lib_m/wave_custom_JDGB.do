...
add wave -noupdate -group SpectialFunctionUnit$i -label clk_i  tb_top_level/uGPGPU/uStreamingMultiProcessor/uPipelineExecute/uSpecialFunctionUnitProcessor/gSpecialFunctionUnit($i)/uSpecialFunctionUnit/clk_i
add wave -noupdate -group SpectialFunctionUnit$i -label rst_n  tb_top_level/uGPGPU/uStreamingMultiProcessor/uPipelineExecute/uSpecialFunctionUnitProcessor/gSpecialFunctionUnit($i)/uSpecialFunctionUnit/rst_n
add wave -noupdate -group SpectialFunctionUnit$i -label start_i  tb_top_level/uGPGPU/uStreamingMultiProcessor/uPipelineExecute/uSpecialFunctionUnitProcessor/gSpecialFunctionUnit($i)/uSpecialFunctionUnit/start_i
add wave -noupdate -group SpectialFunctionUnit$i -label src_1  -radix iee754s_fp tb_top_level/uGPGPU/uStreamingMultiProcessor/uPipelineExecute/uSpecialFunctionUnitProcessor/gSpecialFunctionUnit($i)/uSpecialFunctionUnit/src1_i
add wave -noupdate -group SpectialFunctionUnit$i -label selop_i  tb_top_level/uGPGPU/uStreamingMultiProcessor/uPipelineExecute/uSpecialFunctionUnitProcessor/gSpecialFunctionUnit($i)/uSpecialFunctionUnit/selop_i
add wave -noupdate -group SpectialFunctionUnit$i -label Result_o -radix iee754s_fp tb_top_level/uGPGPU/uStreamingMultiProcessor/uPipelineExecute/uSpecialFunctionUnitProcessor/gSpecialFunctionUnit($i)/uSpecialFunctionUnit/Result_o
add wave -noupdate -group SpectialFunctionUnit$i -label stall_o  tb_top_level/uGPGPU/uStreamingMultiProcessor/uPipelineExecute/uSpecialFunctionUnitProcessor/gSpecialFunctionUnit($i)/uSpecialFunctionUnit/stall_o
